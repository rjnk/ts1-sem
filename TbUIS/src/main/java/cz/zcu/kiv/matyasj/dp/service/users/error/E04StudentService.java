 ...
 */
//@Service
public class E04StudentService extends BaseStudentService {
    /** Shared system logger */
    private final Logger log = LogManager.getLogger();


    /**
     * E04StudentService constructor is needed because of dependencies in parent (BaseStudentService) constructor.
     *
     ...
     */
    @Autowired
    public E04StudentService(SubjectDao subjectDao, UserDao userDao, ExaminationDateDao examinationDateDao, GradeDao gradeDao, GradeTypeDao gradeTypeDao, PropertyLoader propertyLoader) {
     ...
     */
    @Override
    @ErrorMethod(errorMessage = "This error method shows overview view after removal of subject.")
