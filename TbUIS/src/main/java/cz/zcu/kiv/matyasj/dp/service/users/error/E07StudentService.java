 ...
 */
//@Service
public class E07StudentService extends BaseStudentService {
    /** Shared system logger */
    private final Logger log = LogManager.getLogger();


    /**
     * E07StudentService constructor is needed because of dependencies in parent (BaseStudentService) constructor.
     *
     ...
     */
    @Autowired
    public E07StudentService(SubjectDao subjectDao, UserDao userDao, ExaminationDateDao examinationDateDao, GradeDao gradeDao, GradeTypeDao gradeTypeDao, PropertyLoader propertyLoader) {
     ...
     * DELIBERATE ERROR
     *
     * This error method changes color of Participants button
     *
     * @return Indication whether to change color of button
     */
    @Override
    @ErrorMethod(errorMessage = "This error method changes color of participants button.")
    public boolean changeParticipantsButtonColor() {
        log.error(propertyLoader.getProperty("log.E07StudentService.changeParticipantsButtonColor"));
        return true;
    }
