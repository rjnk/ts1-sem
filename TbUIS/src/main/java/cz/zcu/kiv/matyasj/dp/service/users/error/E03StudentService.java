 ...
 */
//@Service
public class E03StudentService extends BaseStudentService {
    /** Shared system logger */
    private final Logger log = LogManager.getLogger();


    /**
     * E03StudentService constructor is needed because of dependencies in parent (BaseStudentService) constructor.
     *
     ...
     */
    @Autowired
    public E03StudentService(SubjectDao subjectDao, UserDao userDao, ExaminationDateDao examinationDateDao, GradeDao gradeDao, GradeTypeDao gradeTypeDao, PropertyLoader propertyLoader) {
     ...
     * DELIBERATE ERROR
     *
     * This error method changes title
     *
     * @return Changed Title
     */
    @Override
    @ErrorMethod(errorMessage = "This error method changes title.")
    public String setTitle() {
        log.error(propertyLoader.getProperty("log.E03StudentService.setTitle"));
        return "Stu view";
    }
}