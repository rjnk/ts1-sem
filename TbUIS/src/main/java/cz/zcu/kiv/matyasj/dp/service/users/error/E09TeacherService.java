 ...
 * @author Jakub Smaus
 */
public class E09TeacherService extends BaseTeacherService {
    /** Shared system logger */
    private final Logger log = LogManager.getLogger();

    /**
     * E09TeacherService constructor is needed because of dependencies in parent (BaseTeacherService) constructor.
     *
     ...
     */
    @Autowired
    public E09TeacherService(SubjectDao subjectDao, UserDao userDao, ExaminationDateDao examinationDateDao, GradeDao gradeDao, GradeTypeDao gradeTypeDao, DateUtility dateUtility, PropertyLoader propertyLoader) {
     ...
     * even if maxParticipants is negative. Negative number of maxParticipants is not validated and stays the same.
     *
     *
     ...
     */
    @Override
    @ErrorMethod(errorMessage = "This method causes no verification of negative numbers and does not change their values.")
    public boolean createNewExaminationTerm(Teacher teacher, Long subjectId, String dateOfTerm, String maxParticipants) {
        ...
        if (newExaminationDate != null && newExaminationDate.getId() != null) {
            log.error(propertyLoader.getProperty("log.E09TeacherService.createNewExaminationTerm"));
            return true;
        }
