 ...
 * @author Jakub Smaus
 */
public class E11TeacherService extends BaseTeacherService {
    /** Shared system logger */
    private final Logger log = LogManager.getLogger();

    /**
     * E11TeacherService constructor is needed because of dependencies in parent (BaseTeacherService) constructor.
     *
     ...
     */
    @Autowired
    public E11TeacherService(SubjectDao subjectDao, UserDao userDao, ExaminationDateDao examinationDateDao, GradeDao gradeDao, GradeTypeDao gradeTypeDao, DateUtility dateUtility, PropertyLoader propertyLoader) {
     ...
     * even if maxParticipants is negative. Negative number of maxParticipants is not validated but is
     ...
     */
    @Override
    @ErrorMethod(errorMessage = "This method causes no verification of negative numbers and converts them to positive.")
    public boolean createNewExaminationTerm(Teacher teacher, Long subjectId, String dateOfTerm, String maxParticipants) {
        ...
        if (maxParticipantsInt >= 0) {
            ...
            maxParticipantsInt = Math.abs(maxParticipantsInt);
        }
        ...
        if (newExaminationDate != null && newExaminationDate.getId() != null) {
            log.error(propertyLoader.getProperty("log.E11TeacherService.createNewExaminationTerm"));
            return true;
        }
